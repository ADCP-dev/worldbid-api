...
| `coolify-deploy` | Trigger: deploy to coolify, coolify api, create coolify app, coolify deploy, dockerfile deploy coolify, coolify env vars, coolify domains. Deploy Dockerfile-based apps to Coolify via REST API + Caddy proxy. | user | `/home/dev/.config/opencode/skills/coolify-deploy/SKILL.md` |
