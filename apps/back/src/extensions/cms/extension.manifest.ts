...
const manifest: ExtensionManifest = {
  ...
  contributes: {
    ...
    entities: [
      { name: 'Page', table: 'page' },
      { name: 'BlogPost', table: 'blog_post' },
      { name: 'BlogCategory', table: 'blog_category' },
      { name: 'Tag', table: 'post_tag' },
      { name: 'SeoMetadata', table: 'seo_metadata' },
    ],
    seeds: true,
    config: ['cms'],
    menuItems: [
      {
        ...
        items: [
          ...
          { title: 'Categories', icon: 'folder', link: '/admin/cms/blog/categories' },
    ...
    permissions: [
      ...
      { action: 'cms:posts:publish', description: 'Publish/unpublish blog posts' },
      { action: 'cms:categories:manage', description: 'Manage blog categories' },
