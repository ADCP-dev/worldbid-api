...
export class AppConfig1783427248641 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_61c85fd9e5a04dd5bc9b006ed8" ON "app_setting" ("section") `);
        await queryRunner.query(`ALTER TABLE "ext_affiliate_partner" ALTER COLUMN "commissionRate" SET DEFAULT '0.05'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ext_affiliate_partner" ALTER COLUMN "commissionRate" SET DEFAULT 0.05`);
        await queryRunner.query(`DROP INDEX "public"."IDX_61c85fd9e5a04dd5bc9b006ed8"`);
