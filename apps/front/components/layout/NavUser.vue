...
<template>
  <div class="dropdown dropdown-top is-drawer-close:dropdown-right w-full">
    <div tabindex="0" role="button" class="btn btn-ghost w-full justify-start is-drawer-close:justify-center px-2 is-drawer-close:px-0 h-auto py-2 bg-base-200 hover:bg-base-300">
      <div class="avatar">
