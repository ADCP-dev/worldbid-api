...
function onSubmit() {
  ...
  toast.success("Form submitted!", {
    description: h(
      "pre",
      { class: "mt-2 w-full rounded-md bg-neutral p-4" },
      h(
        "code",
        { class: "text-neutral-content text-xs" },
    ...
    <div class="flex flex-col gap-8 max-w-2xl mx-auto">
      <div>
        ...
        <p class="text-base-content/60">
          Ejemplo de uso de componentes de formulario modulares con validación
          Zod y daisyUI.
        </p>
      </div>
      ...
      <div class="alert alert-info shadow-sm">
        ...
        <div>
          ...
          <div class="text-xs">
            Este formulario utiliza Zod para la validación de esquemas y muestra
            los errores directamente bajo cada campo.
          </div>
        </div>
      </div>
    </div>
