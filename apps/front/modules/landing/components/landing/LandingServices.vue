...
<template>
  <section id="services" class="container mx-auto py-24 sm:py-32" data-aos="fade-up">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="space-y-16 max-w-6xl mx-auto">
        <div
v-for="({ title, description, tier, icon }, index) in serviceList" :key="title" :class="[
          'flex flex-col lg:flex-row items-center gap-8 lg:gap-24 my-32',
          ...
          <div class="flex-shrink-0 relative">
            <div class="relative">
              <div
                class="w-32 h-32 lg:w-40 lg:h-40 bg-gradient-to-br from-primary/20 to-primary/5 rounded-3xl flex items-center justify-center group hover:scale-105 transition-all duration-300">
                <component
:is="iconMap[icon]"
              ...
              <!-- Decorative elements -->
              <div class="absolute -top-4 -left-4 w-8 h-8 bg-primary/10 rounded-full animate-pulse"/>
              <div class="absolute -bottom-2 -right-2 w-6 h-6 bg-primary/20 rounded-full animate-pulse delay-300"/>
            </div>
          </div>
          ...
          <div class="flex-1 text-center lg:text-left space-y-4">
            <div class="space-y-2">
              <h3 class="text-2xl lg:text-3xl font-bold text-foreground group-hover:text-primary transition-colors">
                {{ title }}
              </h3>
              <div class="w-16 h-1 bg-gradient-to-r from-primary to-primary/50 mx-auto lg:mx-0 rounded-full"/>
            </div>
            ...
            <div class="flex items-center justify-center lg:justify-start gap-2 pt-2">
              ...
              <div class="w-2 h-2 bg-primary/70 rounded-full animate-bounce delay-100"/>
              <div class="w-2 h-2 bg-primary/40 rounded-full animate-bounce delay-200"/>
            </div>
          </div>
        </div>
      </div>
