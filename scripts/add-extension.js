 ...
 *
 * Usage:
 *   node scripts/add-extension.js <extension-name> [zip-path]
 *
 * Examples:
 *   node scripts/add-extension.js blog ./downloads/blog-v1.0.0.zip
 *   node scripts/add-extension.js cms   # extension already in extensions/cms/
 *
 * Flow:
...
function main() {
  ...
  if (args.length < 1) {
    console.error('Usage: node scripts/add-extension.js <extension-name> [zip-path]');
    console.error('');
