 ...
 *
 * Usage:
 *   node scripts/build-extension.js <extension-name> [version]
 *
 * Examples:
 *   node scripts/build-extension.js blog
 *   node scripts/build-extension.js cms 1.2.0
 *
 * Output:
...
function main() {
  ...
  if (!extName) {
    error('Usage: node scripts/build-extension.js <extension-name> [version]');
  }
